...
class InvestController extends Controller {
     ...
     *       name="marcin_admin_invest_send_invest"
     * )
     *
     */
       ...
       $em = $this->getDoctrine()->getManager();
        ...
        $em->flush();
            ...
            $sprwadzam = $zamowienia_klinar->getId();
             ...
             return $this->redirect($this->generateUrl('marcin_admin_invest_podglad', array('id' => $sprwadzam)));
    }
    }
     ...
     * @Route(
     *       "/invest/b/podglad/{id}",
     *       name="marcin_admin_invest_podglad",
     *       requirements={"id"="\d+"}
     * )
     *    
     * @Template()
     ...
     * @Template()
     */
    public function investpokazAction(Request $Request, $status, $page) {
        $queryParams = array(
        ...
        $statistics = $StatZam->getStatisticsInvestPanel();
        
        $qb = $StatZam->getInvestPanelBuilder($queryParams);
     ...
     *      name="marcin_admin_invest_delete",
     *      requirements={"id"="\d+"}
     * )
     * 
     * @Template()
