...
class AwaxController extends Controller {
     ...
     *       name="marcin_admin_shoper_send_awax"
     * )
     *
     */
    public function sendawaxAction($id, $idzam) {
       ...
       return $this->redirect($this->generateUrl('marcin_admin_awax'));
    }
    
    /**
     * @Route(
     *       "/{status}/{page}",
     *       name="marcin_admin_awax",
     *       requirements={"page"="\d+"},
    ...
    public function indexAction(Request $Request,$status ,$page) {
        ...
        $statistics = $StatZam->getStatisticsawax();
        
        $qb = $StatZam->getAwaxBuilder($queryParams);
        ...
        return $this->render('MarcinAdminBundle:Awax:index.html.twig',
            array(
            'pageTitle'            => 'GM Panel Shoper zamówienia Awax',
    ...
    /**
     * @Route(
     *      "/awax/show/zamowienie/{idzam}", 
     *      name="marcin_admin_shoper_awax_show",
     *      requirements={"id"="\d+"},
     *      defaults={"id"=NULL}
     * )
     * 
    ...
    public function awaxshowAction(Request $Request, $idzam) {
       ...
       $em = $this->getDoctrine()->getManager();
        ...
        if ($qb_klinar == null) {
             ...
             return $this->redirect($this->generateUrl('marcin_admin_shoper_awax'));
        } else {
        ...
        $zamowienia_klinar->setKategoria("AWAX");
        ...
        $em->flush();
            ...
            $sprwadzam = $zamowienia_klinar->getId();
             ...
             return $this->redirect($this->generateUrl('marcin_admin_shoper_awax_podglad', array('id' => $sprwadzam)));
    }
    }
     ...
     * @Route(
     *       "/awax/b/podglad/{id}",
     *       name="marcin_admin_shoper_awax_podglad",
     *       requirements={"id"="\d+"}
     * )
     *    
     * @Template()
    ...
    public function apodgladAction(Request $Request, $id, Shoperklinar $Shoper = NULL) {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('marcin_admin_awax_pokaz', array(
                                'id' => $Shoper->getId()
            )));
        }

        return $this->render('MarcinAdminBundle:Awax:awax_edit.html.twig', array(
     ...
     * @Template()
     */
    public function awaxpokazAction(Request $Request, $page) {
        $queryParams = array(
        ...
        return $this->render('MarcinAdminBundle:Awax:awax.html.twig',
            array(
            'pageTitle'            => 'GM Panel Shoper zamówienia Awax',
            'queryParams' => $queryParams,
            'limits' => $limits,
    ...
    /**
     * @Route(
     *      "/awax/b/pokaz/usun/{id}/{token}", 
     *      name="marcin_admin_shoper_awax_delete",
     *      requirements={"id"="\d+"}
     * )
     * 
     * @Template()
