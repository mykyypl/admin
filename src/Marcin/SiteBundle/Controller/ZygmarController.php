...
class ZygmarController extends Controller {
    ...
    public function formAction(Request $Request, $id, Shoperklinar $Shoper = NULL) {
         ...
         if (null == $Shoper) {
             ...
             return $this->redirect($this->generateUrl('marcin_site_zygmar'));
        }
...
//            $Shoper->setFile($fileName);
            ...
            return $this->redirect($this->generateUrl('marcin_site_zygmar', array(
                                'id' => $Shoper->getId()
            )));
        }
       ...
       // $qb = $em->getRepository('MarcinSiteBundle:Shoperklinar')->getKlinarSendBuilder();
        ...
        return $this->render('MarcinSiteBundle:Zygmar:form.html.twig',
            array(
    ...
    public function indexAction(Request $Request,$status ,$page)
    {
        ...
        $KlinarZam = $this->getDoctrine()->getRepository('MarcinSiteBundle:Shoperklinar');
        $statistics = $KlinarZam->getStatisticsZygmar();
        
        $qb = $KlinarZam->getZygmarBuilder($queryParams);
        ...
        return $this->render('MarcinSiteBundle:Zygmar:index.html.twig',
            array(
            'pageTitle'            => 'GM Panel Zygmar',
