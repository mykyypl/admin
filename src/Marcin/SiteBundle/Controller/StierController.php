...
class StierController extends Controller {
    
    /**
     * @Route(
     *      "/form/{id}", 
     *      name="marcin_site_stier_form",
     *      requirements={"id"="\d+"}
     * )
     * 
     * @Template()
    ...
    public function formAction(Request $Request, $id, Shoperklinar $Shoper = NULL) {
         ...
         if (null == $Shoper) {
             ...
             return $this->redirect($this->generateUrl('marcin_site_stier'));
        }
...
//            $Shoper->setFile($fileName);
            ...
            return $this->redirect($this->generateUrl('marcin_site_stier', array(
                                'id' => $Shoper->getId()
            )));
        }
       ...
       // $qb = $em->getRepository('MarcinSiteBundle:Shoperklinar')->getKlinarSendBuilder();
        $qb = $KlinarZam->getStierSendBuilder($id);
        ...
        return $this->render('MarcinSiteBundle:Stier:form.html.twig',
            array(
    ...
    public function indexAction(Request $Request,$status ,$page)
    {
        ...
        $KlinarZam = $this->getDoctrine()->getRepository('MarcinSiteBundle:Shoperklinar');
        $statistics = $KlinarZam->getStatisticsStier();
        
        $qb = $KlinarZam->getHannoBuilder($queryParams);
        ...
        return $this->render('MarcinSiteBundle:Stier:index.html.twig',
            array(
            'pageTitle'            => 'GM Panel Stier',
